...
public class CalculatorApplication  implements ActionListener {
    ...
    JButton buttonSqurt=new JButton("\u221A");
    ...
    public void addComponents(){
        ...
        buttonSqurt.setBounds(10,170,60,40);
        buttonSqurt.setFont(new Font("Arial",Font.BOLD,18));
        buttonSqurt.setFocusable(false);
        frame.add(buttonSqurt);
    ...
    public void addActionEvent(){
        ...
        buttonSqurt.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
       ...
       }else if (source==buttonSqurt){
           num1=Double.parseDouble(textField.getText());
           double squrt=Math.sqrt(num1);
           textField.setText(Double.toString(squrt));
